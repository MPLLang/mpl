...
typedef bool (*GC_objptrPredicateFun) (GC_state s, pointer p, void *env);

typedef struct GC_objptrPredicateClosure {
  GC_objptrPredicateFun fun;
  void *env;
} *GC_objptrPredicateClosure;
