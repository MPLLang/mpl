...
struct
  ...
  val yield = _import "Parallel_yield": unit -> unit;

  val takeLock = _import "Parallel_lockTake": int ref -> unit;
  val releaseLock = _import "Parallel_lockRelease": int ref -> unit;

  local 
    val takeDekker = _import "Parallel_dekkerTake": bool * bool ref * bool ref * bool ref -> unit;
    val releaseDekker = _import "Parallel_dekkerRelease": bool * bool ref * bool ref * bool ref -> unit;
  in
