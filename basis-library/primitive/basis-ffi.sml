...
val sigaddset = _import "Posix_Signal_sigaddset" private : (Word8.t) array * C_Signal.t -> (C_Int.t) C_Errno.t;
...
val sigdelset = _import "Posix_Signal_sigdelset" private : (Word8.t) array * C_Signal.t -> (C_Int.t) C_Errno.t;
val sigemptyset = _import "Posix_Signal_sigemptyset" private : (Word8.t) array -> (C_Int.t) C_Errno.t;
val sigfillset = _import "Posix_Signal_sigfillset" private : (Word8.t) array -> (C_Int.t) C_Errno.t;
...
val sigismember = _import "Posix_Signal_sigismember" private : (Word8.t) vector * C_Signal.t -> (C_Int.t) C_Errno.t;
...
val sigprocmask = _import "Posix_Signal_sigprocmask" private : C_Int.t * (Word8.t) vector * (Word8.t) array -> (C_Int.t) C_Errno.t;
...
val sigSetLen = _const "Posix_Signal_sigSetLen" : C_Size.t;
val SIGSTOP = _const "Posix_Signal_SIGSTOP" : C_Signal.t;
val sigsuspend = _import "Posix_Signal_sigsuspend" private : (Word8.t) vector -> unit;
...
struct
type t = Real32.t
val abs = _import "Real32_abs" private inline : Real32.t -> Real32.t;
val add = _import "Real32_add" private inline : Real32.t * Real32.t -> Real32.t;
val castToWord32 = _import "Real32_castToWord32" private inline : Real32.t -> Word32.t;
val div = _import "Real32_div" private inline : Real32.t * Real32.t -> Real32.t;
val equal = _import "Real32_equal" private inline : Real32.t * Real32.t -> Bool.t;
...
structure Math = 
struct
val acos = _import "Real32_Math_acos" private inline : Real32.t -> Real32.t;
val asin = _import "Real32_Math_asin" private inline : Real32.t -> Real32.t;
val atan = _import "Real32_Math_atan" private inline : Real32.t -> Real32.t;
val atan2 = _import "Real32_Math_atan2" private inline : Real32.t * Real32.t -> Real32.t;
val cos = _import "Real32_Math_cos" private inline : Real32.t -> Real32.t;
val cosh = _import "Real32_Math_cosh" private inline : Real32.t -> Real32.t;
val exp = _import "Real32_Math_exp" private inline : Real32.t -> Real32.t;
val ln = _import "Real32_Math_ln" private inline : Real32.t -> Real32.t;
val log10 = _import "Real32_Math_log10" private inline : Real32.t -> Real32.t;
val pow = _import "Real32_Math_pow" private inline : Real32.t * Real32.t -> Real32.t;
val sin = _import "Real32_Math_sin" private inline : Real32.t -> Real32.t;
val sinh = _import "Real32_Math_sinh" private inline : Real32.t -> Real32.t;
val sqrt = _import "Real32_Math_sqrt" private inline : Real32.t -> Real32.t;
val tan = _import "Real32_Math_tan" private inline : Real32.t -> Real32.t;
val tanh = _import "Real32_Math_tanh" private inline : Real32.t -> Real32.t;
end
val modf = _import "Real32_modf" private inline : Real32.t * (Real32.t) ref -> Real32.t;
val move = _import "Real32_move" private inline : (Real32.t) ref * (Real32.t) ref -> unit;
val mul = _import "Real32_mul" private inline : Real32.t * Real32.t -> Real32.t;
val muladd = _import "Real32_muladd" private inline : Real32.t * Real32.t * Real32.t -> Real32.t;
val mulsub = _import "Real32_mulsub" private inline : Real32.t * Real32.t * Real32.t -> Real32.t;
val neg = _import "Real32_neg" private inline : Real32.t -> Real32.t;
val realCeil = _import "Real32_realCeil" private inline : Real32.t -> Real32.t;
val realFloor = _import "Real32_realFloor" private inline : Real32.t -> Real32.t;
val realTrunc = _import "Real32_realTrunc" private inline : Real32.t -> Real32.t;
val rndToReal32 = _import "Real32_rndToReal32" private inline : Real32.t -> Real32.t;
val rndToReal64 = _import "Real32_rndToReal64" private inline : Real32.t -> Real64.t;
val rndToWordS16 = _import "Real32_rndToWordS16" private inline : Real32.t -> Int16.t;
val rndToWordS32 = _import "Real32_rndToWordS32" private inline : Real32.t -> Int32.t;
val rndToWordS64 = _import "Real32_rndToWordS64" private inline : Real32.t -> Int64.t;
val rndToWordS8 = _import "Real32_rndToWordS8" private inline : Real32.t -> Int8.t;
val rndToWordU16 = _import "Real32_rndToWordU16" private inline : Real32.t -> Word16.t;
val rndToWordU32 = _import "Real32_rndToWordU32" private inline : Real32.t -> Word32.t;
val rndToWordU64 = _import "Real32_rndToWordU64" private inline : Real32.t -> Word64.t;
val rndToWordU8 = _import "Real32_rndToWordU8" private inline : Real32.t -> Word8.t;
val round = _import "Real32_round" private inline : Real32.t -> Real32.t;
val store = _import "Real32_store" private inline : (Real32.t) ref * Real32.t -> unit;
val strtor = _import "Real32_strtor" private : NullString8.t * C_Int.t -> Real32.t;
val sub = _import "Real32_sub" private inline : Real32.t * Real32.t -> Real32.t;
end
structure Real64 = 
struct
type t = Real64.t
val abs = _import "Real64_abs" private inline : Real64.t -> Real64.t;
val add = _import "Real64_add" private inline : Real64.t * Real64.t -> Real64.t;
val castToWord64 = _import "Real64_castToWord64" private inline : Real64.t -> Word64.t;
val div = _import "Real64_div" private inline : Real64.t * Real64.t -> Real64.t;
val equal = _import "Real64_equal" private inline : Real64.t * Real64.t -> Bool.t;
...
structure Math = 
struct
val acos = _import "Real64_Math_acos" private inline : Real64.t -> Real64.t;
val asin = _import "Real64_Math_asin" private inline : Real64.t -> Real64.t;
val atan = _import "Real64_Math_atan" private inline : Real64.t -> Real64.t;
val atan2 = _import "Real64_Math_atan2" private inline : Real64.t * Real64.t -> Real64.t;
val cos = _import "Real64_Math_cos" private inline : Real64.t -> Real64.t;
val cosh = _import "Real64_Math_cosh" private inline : Real64.t -> Real64.t;
val exp = _import "Real64_Math_exp" private inline : Real64.t -> Real64.t;
val ln = _import "Real64_Math_ln" private inline : Real64.t -> Real64.t;
val log10 = _import "Real64_Math_log10" private inline : Real64.t -> Real64.t;
val pow = _import "Real64_Math_pow" private inline : Real64.t * Real64.t -> Real64.t;
val sin = _import "Real64_Math_sin" private inline : Real64.t -> Real64.t;
val sinh = _import "Real64_Math_sinh" private inline : Real64.t -> Real64.t;
val sqrt = _import "Real64_Math_sqrt" private inline : Real64.t -> Real64.t;
val tan = _import "Real64_Math_tan" private inline : Real64.t -> Real64.t;
val tanh = _import "Real64_Math_tanh" private inline : Real64.t -> Real64.t;
end
val modf = _import "Real64_modf" private inline : Real64.t * (Real64.t) ref -> Real64.t;
val move = _import "Real64_move" private inline : (Real64.t) ref * (Real64.t) ref -> unit;
val mul = _import "Real64_mul" private inline : Real64.t * Real64.t -> Real64.t;
val muladd = _import "Real64_muladd" private inline : Real64.t * Real64.t * Real64.t -> Real64.t;
val mulsub = _import "Real64_mulsub" private inline : Real64.t * Real64.t * Real64.t -> Real64.t;
val neg = _import "Real64_neg" private inline : Real64.t -> Real64.t;
val realCeil = _import "Real64_realCeil" private inline : Real64.t -> Real64.t;
val realFloor = _import "Real64_realFloor" private inline : Real64.t -> Real64.t;
val realTrunc = _import "Real64_realTrunc" private inline : Real64.t -> Real64.t;
val rndToReal32 = _import "Real64_rndToReal32" private inline : Real64.t -> Real32.t;
val rndToReal64 = _import "Real64_rndToReal64" private inline : Real64.t -> Real64.t;
val rndToWordS16 = _import "Real64_rndToWordS16" private inline : Real64.t -> Int16.t;
val rndToWordS32 = _import "Real64_rndToWordS32" private inline : Real64.t -> Int32.t;
val rndToWordS64 = _import "Real64_rndToWordS64" private inline : Real64.t -> Int64.t;
val rndToWordS8 = _import "Real64_rndToWordS8" private inline : Real64.t -> Int8.t;
val rndToWordU16 = _import "Real64_rndToWordU16" private inline : Real64.t -> Word16.t;
val rndToWordU32 = _import "Real64_rndToWordU32" private inline : Real64.t -> Word32.t;
val rndToWordU64 = _import "Real64_rndToWordU64" private inline : Real64.t -> Word64.t;
val rndToWordU8 = _import "Real64_rndToWordU8" private inline : Real64.t -> Word8.t;
val round = _import "Real64_round" private inline : Real64.t -> Real64.t;
val store = _import "Real64_store" private inline : (Real64.t) ref * Real64.t -> unit;
val strtor = _import "Real64_strtor" private : NullString8.t * C_Int.t -> Real64.t;
val sub = _import "Real64_sub" private inline : Real64.t * Real64.t -> Real64.t;
end
structure Socket = 
struct
...
struct
type t = Word16.t
val add = _import "Word16_add" private inline : Word16.t * Word16.t -> Word16.t;
val andb = _import "Word16_andb" private inline : Word16.t * Word16.t -> Word16.t;
val equal = _import "Word16_equal" private inline : Word16.t * Word16.t -> Bool.t;
val lshift = _import "Word16_lshift" private inline : Word16.t * Word32.t -> Word16.t;
val neg = _import "Word16_neg" private inline : Word16.t -> Word16.t;
val notb = _import "Word16_notb" private inline : Word16.t -> Word16.t;
val orb = _import "Word16_orb" private inline : Word16.t * Word16.t -> Word16.t;
val rol = _import "Word16_rol" private inline : Word16.t * Word32.t -> Word16.t;
val ror = _import "Word16_ror" private inline : Word16.t * Word32.t -> Word16.t;
val sub = _import "Word16_sub" private inline : Word16.t * Word16.t -> Word16.t;
val xorb = _import "Word16_xorb" private inline : Word16.t * Word16.t -> Word16.t;
end
structure Word32 = 
struct
type t = Word32.t
val add = _import "Word32_add" private inline : Word32.t * Word32.t -> Word32.t;
val andb = _import "Word32_andb" private inline : Word32.t * Word32.t -> Word32.t;
val castToReal32 = _import "Word32_castToReal32" private inline : Word32.t -> Real32.t;
val equal = _import "Word32_equal" private inline : Word32.t * Word32.t -> Bool.t;
val lshift = _import "Word32_lshift" private inline : Word32.t * Word32.t -> Word32.t;
val neg = _import "Word32_neg" private inline : Word32.t -> Word32.t;
val notb = _import "Word32_notb" private inline : Word32.t -> Word32.t;
val orb = _import "Word32_orb" private inline : Word32.t * Word32.t -> Word32.t;
val rol = _import "Word32_rol" private inline : Word32.t * Word32.t -> Word32.t;
val ror = _import "Word32_ror" private inline : Word32.t * Word32.t -> Word32.t;
val sub = _import "Word32_sub" private inline : Word32.t * Word32.t -> Word32.t;
val xorb = _import "Word32_xorb" private inline : Word32.t * Word32.t -> Word32.t;
end
structure Word64 = 
struct
type t = Word64.t
val add = _import "Word64_add" private inline : Word64.t * Word64.t -> Word64.t;
val andb = _import "Word64_andb" private inline : Word64.t * Word64.t -> Word64.t;
val castToReal64 = _import "Word64_castToReal64" private inline : Word64.t -> Real64.t;
val equal = _import "Word64_equal" private inline : Word64.t * Word64.t -> Bool.t;
val fetch = _import "Word64_fetch" private inline : (Word64.t) ref -> Word64.t;
val lshift = _import "Word64_lshift" private inline : Word64.t * Word32.t -> Word64.t;
val move = _import "Word64_move" private inline : (Word64.t) ref * (Word64.t) ref -> unit;
val neg = _import "Word64_neg" private inline : Word64.t -> Word64.t;
val notb = _import "Word64_notb" private inline : Word64.t -> Word64.t;
val orb = _import "Word64_orb" private inline : Word64.t * Word64.t -> Word64.t;
val rol = _import "Word64_rol" private inline : Word64.t * Word32.t -> Word64.t;
val ror = _import "Word64_ror" private inline : Word64.t * Word32.t -> Word64.t;
val store = _import "Word64_store" private inline : (Word64.t) ref * Word64.t -> unit;
val sub = _import "Word64_sub" private inline : Word64.t * Word64.t -> Word64.t;
val xorb = _import "Word64_xorb" private inline : Word64.t * Word64.t -> Word64.t;
end
structure Word8 = 
struct
type t = Word8.t
val add = _import "Word8_add" private inline : Word8.t * Word8.t -> Word8.t;
val andb = _import "Word8_andb" private inline : Word8.t * Word8.t -> Word8.t;
val equal = _import "Word8_equal" private inline : Word8.t * Word8.t -> Bool.t;
val lshift = _import "Word8_lshift" private inline : Word8.t * Word32.t -> Word8.t;
val neg = _import "Word8_neg" private inline : Word8.t -> Word8.t;
val notb = _import "Word8_notb" private inline : Word8.t -> Word8.t;
val orb = _import "Word8_orb" private inline : Word8.t * Word8.t -> Word8.t;
val rol = _import "Word8_rol" private inline : Word8.t * Word32.t -> Word8.t;
val ror = _import "Word8_ror" private inline : Word8.t * Word32.t -> Word8.t;
val sub = _import "Word8_sub" private inline : Word8.t * Word8.t -> Word8.t;
val xorb = _import "Word8_xorb" private inline : Word8.t * Word8.t -> Word8.t;
end
structure WordS16 = 
struct
val addCheckP = _import "WordS16_addCheckP" private inline : Int16.t * Int16.t -> Bool.t;
val extdToWord16 = _import "WordS16_extdToWord16" private inline : Int16.t -> Word16.t;
val extdToWord32 = _import "WordS16_extdToWord32" private inline : Int16.t -> Word32.t;
val extdToWord64 = _import "WordS16_extdToWord64" private inline : Int16.t -> Word64.t;
val extdToWord8 = _import "WordS16_extdToWord8" private inline : Int16.t -> Word8.t;
val ge = _import "WordS16_ge" private inline : Int16.t * Int16.t -> Bool.t;
val gt = _import "WordS16_gt" private inline : Int16.t * Int16.t -> Bool.t;
val le = _import "WordS16_le" private inline : Int16.t * Int16.t -> Bool.t;
val lt = _import "WordS16_lt" private inline : Int16.t * Int16.t -> Bool.t;
val mul = _import "WordS16_mul" private inline : Int16.t * Int16.t -> Int16.t;
val mulCheckP = _import "WordS16_mulCheckP" private inline : Int16.t * Int16.t -> Bool.t;
val negCheckP = _import "WordS16_negCheckP" private inline : Int16.t -> Bool.t;
val quot = _import "WordS16_quot" private inline : Int16.t * Int16.t -> Int16.t;
val rem = _import "WordS16_rem" private inline : Int16.t * Int16.t -> Int16.t;
...
val rshift = _import "WordS16_rshift" private inline : Int16.t * Word32.t -> Int16.t;
val subCheckP = _import "WordS16_subCheckP" private inline : Int16.t * Int16.t -> Bool.t;
end
structure WordS32 = 
struct
val addCheckP = _import "WordS32_addCheckP" private inline : Int32.t * Int32.t -> Bool.t;
val extdToWord16 = _import "WordS32_extdToWord16" private inline : Int32.t -> Word16.t;
val extdToWord32 = _import "WordS32_extdToWord32" private inline : Int32.t -> Word32.t;
val extdToWord64 = _import "WordS32_extdToWord64" private inline : Int32.t -> Word64.t;
val extdToWord8 = _import "WordS32_extdToWord8" private inline : Int32.t -> Word8.t;
val ge = _import "WordS32_ge" private inline : Int32.t * Int32.t -> Bool.t;
val gt = _import "WordS32_gt" private inline : Int32.t * Int32.t -> Bool.t;
val le = _import "WordS32_le" private inline : Int32.t * Int32.t -> Bool.t;
val lt = _import "WordS32_lt" private inline : Int32.t * Int32.t -> Bool.t;
val mul = _import "WordS32_mul" private inline : Int32.t * Int32.t -> Int32.t;
val mulCheckP = _import "WordS32_mulCheckP" private inline : Int32.t * Int32.t -> Bool.t;
val negCheckP = _import "WordS32_negCheckP" private inline : Int32.t -> Bool.t;
val quot = _import "WordS32_quot" private inline : Int32.t * Int32.t -> Int32.t;
val rem = _import "WordS32_rem" private inline : Int32.t * Int32.t -> Int32.t;
...
val rshift = _import "WordS32_rshift" private inline : Int32.t * Word32.t -> Int32.t;
val subCheckP = _import "WordS32_subCheckP" private inline : Int32.t * Int32.t -> Bool.t;
end
structure WordS64 = 
struct
val addCheckP = _import "WordS64_addCheckP" private inline : Int64.t * Int64.t -> Bool.t;
val extdToWord16 = _import "WordS64_extdToWord16" private inline : Int64.t -> Word16.t;
val extdToWord32 = _import "WordS64_extdToWord32" private inline : Int64.t -> Word32.t;
val extdToWord64 = _import "WordS64_extdToWord64" private inline : Int64.t -> Word64.t;
val extdToWord8 = _import "WordS64_extdToWord8" private inline : Int64.t -> Word8.t;
val ge = _import "WordS64_ge" private inline : Int64.t * Int64.t -> Bool.t;
val gt = _import "WordS64_gt" private inline : Int64.t * Int64.t -> Bool.t;
val le = _import "WordS64_le" private inline : Int64.t * Int64.t -> Bool.t;
val lt = _import "WordS64_lt" private inline : Int64.t * Int64.t -> Bool.t;
val mul = _import "WordS64_mul" private inline : Int64.t * Int64.t -> Int64.t;
val mulCheckP = _import "WordS64_mulCheckP" private inline : Int64.t * Int64.t -> Bool.t;
val negCheckP = _import "WordS64_negCheckP" private inline : Int64.t -> Bool.t;
val quot = _import "WordS64_quot" private inline : Int64.t * Int64.t -> Int64.t;
val rem = _import "WordS64_rem" private inline : Int64.t * Int64.t -> Int64.t;
...
val rshift = _import "WordS64_rshift" private inline : Int64.t * Word32.t -> Int64.t;
val subCheckP = _import "WordS64_subCheckP" private inline : Int64.t * Int64.t -> Bool.t;
end
structure WordS8 = 
struct
val addCheckP = _import "WordS8_addCheckP" private inline : Int8.t * Int8.t -> Bool.t;
val extdToWord16 = _import "WordS8_extdToWord16" private inline : Int8.t -> Word16.t;
val extdToWord32 = _import "WordS8_extdToWord32" private inline : Int8.t -> Word32.t;
val extdToWord64 = _import "WordS8_extdToWord64" private inline : Int8.t -> Word64.t;
val extdToWord8 = _import "WordS8_extdToWord8" private inline : Int8.t -> Word8.t;
val ge = _import "WordS8_ge" private inline : Int8.t * Int8.t -> Bool.t;
val gt = _import "WordS8_gt" private inline : Int8.t * Int8.t -> Bool.t;
val le = _import "WordS8_le" private inline : Int8.t * Int8.t -> Bool.t;
val lt = _import "WordS8_lt" private inline : Int8.t * Int8.t -> Bool.t;
val mul = _import "WordS8_mul" private inline : Int8.t * Int8.t -> Int8.t;
val mulCheckP = _import "WordS8_mulCheckP" private inline : Int8.t * Int8.t -> Bool.t;
val negCheckP = _import "WordS8_negCheckP" private inline : Int8.t -> Bool.t;
val quot = _import "WordS8_quot" private inline : Int8.t * Int8.t -> Int8.t;
val rem = _import "WordS8_rem" private inline : Int8.t * Int8.t -> Int8.t;
...
val rshift = _import "WordS8_rshift" private inline : Int8.t * Word32.t -> Int8.t;
val subCheckP = _import "WordS8_subCheckP" private inline : Int8.t * Int8.t -> Bool.t;
end
structure WordU16 = 
struct
val addCheckP = _import "WordU16_addCheckP" private inline : Word16.t * Word16.t -> Bool.t;
val extdToWord16 = _import "WordU16_extdToWord16" private inline : Word16.t -> Word16.t;
val extdToWord32 = _import "WordU16_extdToWord32" private inline : Word16.t -> Word32.t;
val extdToWord64 = _import "WordU16_extdToWord64" private inline : Word16.t -> Word64.t;
val extdToWord8 = _import "WordU16_extdToWord8" private inline : Word16.t -> Word8.t;
val ge = _import "WordU16_ge" private inline : Word16.t * Word16.t -> Bool.t;
val gt = _import "WordU16_gt" private inline : Word16.t * Word16.t -> Bool.t;
val le = _import "WordU16_le" private inline : Word16.t * Word16.t -> Bool.t;
val lt = _import "WordU16_lt" private inline : Word16.t * Word16.t -> Bool.t;
val mul = _import "WordU16_mul" private inline : Word16.t * Word16.t -> Word16.t;
val mulCheckP = _import "WordU16_mulCheckP" private inline : Word16.t * Word16.t -> Bool.t;
val negCheckP = _import "WordU16_negCheckP" private inline : Word16.t -> Bool.t;
val quot = _import "WordU16_quot" private inline : Word16.t * Word16.t -> Word16.t;
val rem = _import "WordU16_rem" private inline : Word16.t * Word16.t -> Word16.t;
...
val rshift = _import "WordU16_rshift" private inline : Word16.t * Word32.t -> Word16.t;
val subCheckP = _import "WordU16_subCheckP" private inline : Word16.t * Word16.t -> Bool.t;
end
structure WordU32 = 
struct
val addCheckP = _import "WordU32_addCheckP" private inline : Word32.t * Word32.t -> Bool.t;
val extdToWord16 = _import "WordU32_extdToWord16" private inline : Word32.t -> Word16.t;
val extdToWord32 = _import "WordU32_extdToWord32" private inline : Word32.t -> Word32.t;
val extdToWord64 = _import "WordU32_extdToWord64" private inline : Word32.t -> Word64.t;
val extdToWord8 = _import "WordU32_extdToWord8" private inline : Word32.t -> Word8.t;
val ge = _import "WordU32_ge" private inline : Word32.t * Word32.t -> Bool.t;
val gt = _import "WordU32_gt" private inline : Word32.t * Word32.t -> Bool.t;
val le = _import "WordU32_le" private inline : Word32.t * Word32.t -> Bool.t;
val lt = _import "WordU32_lt" private inline : Word32.t * Word32.t -> Bool.t;
val mul = _import "WordU32_mul" private inline : Word32.t * Word32.t -> Word32.t;
val mulCheckP = _import "WordU32_mulCheckP" private inline : Word32.t * Word32.t -> Bool.t;
val negCheckP = _import "WordU32_negCheckP" private inline : Word32.t -> Bool.t;
val quot = _import "WordU32_quot" private inline : Word32.t * Word32.t -> Word32.t;
val rem = _import "WordU32_rem" private inline : Word32.t * Word32.t -> Word32.t;
...
val rshift = _import "WordU32_rshift" private inline : Word32.t * Word32.t -> Word32.t;
val subCheckP = _import "WordU32_subCheckP" private inline : Word32.t * Word32.t -> Bool.t;
end
structure WordU64 = 
struct
val addCheckP = _import "WordU64_addCheckP" private inline : Word64.t * Word64.t -> Bool.t;
val extdToWord16 = _import "WordU64_extdToWord16" private inline : Word64.t -> Word16.t;
val extdToWord32 = _import "WordU64_extdToWord32" private inline : Word64.t -> Word32.t;
val extdToWord64 = _import "WordU64_extdToWord64" private inline : Word64.t -> Word64.t;
val extdToWord8 = _import "WordU64_extdToWord8" private inline : Word64.t -> Word8.t;
val ge = _import "WordU64_ge" private inline : Word64.t * Word64.t -> Bool.t;
val gt = _import "WordU64_gt" private inline : Word64.t * Word64.t -> Bool.t;
val le = _import "WordU64_le" private inline : Word64.t * Word64.t -> Bool.t;
val lt = _import "WordU64_lt" private inline : Word64.t * Word64.t -> Bool.t;
val mul = _import "WordU64_mul" private inline : Word64.t * Word64.t -> Word64.t;
val mulCheckP = _import "WordU64_mulCheckP" private inline : Word64.t * Word64.t -> Bool.t;
val negCheckP = _import "WordU64_negCheckP" private inline : Word64.t -> Bool.t;
val quot = _import "WordU64_quot" private inline : Word64.t * Word64.t -> Word64.t;
val rem = _import "WordU64_rem" private inline : Word64.t * Word64.t -> Word64.t;
...
val rshift = _import "WordU64_rshift" private inline : Word64.t * Word32.t -> Word64.t;
val subCheckP = _import "WordU64_subCheckP" private inline : Word64.t * Word64.t -> Bool.t;
end
structure WordU8 = 
struct
val addCheckP = _import "WordU8_addCheckP" private inline : Word8.t * Word8.t -> Bool.t;
val extdToWord16 = _import "WordU8_extdToWord16" private inline : Word8.t -> Word16.t;
val extdToWord32 = _import "WordU8_extdToWord32" private inline : Word8.t -> Word32.t;
val extdToWord64 = _import "WordU8_extdToWord64" private inline : Word8.t -> Word64.t;
val extdToWord8 = _import "WordU8_extdToWord8" private inline : Word8.t -> Word8.t;
val ge = _import "WordU8_ge" private inline : Word8.t * Word8.t -> Bool.t;
val gt = _import "WordU8_gt" private inline : Word8.t * Word8.t -> Bool.t;
val le = _import "WordU8_le" private inline : Word8.t * Word8.t -> Bool.t;
val lt = _import "WordU8_lt" private inline : Word8.t * Word8.t -> Bool.t;
val mul = _import "WordU8_mul" private inline : Word8.t * Word8.t -> Word8.t;
val mulCheckP = _import "WordU8_mulCheckP" private inline : Word8.t * Word8.t -> Bool.t;
val negCheckP = _import "WordU8_negCheckP" private inline : Word8.t -> Bool.t;
val quot = _import "WordU8_quot" private inline : Word8.t * Word8.t -> Word8.t;
val rem = _import "WordU8_rem" private inline : Word8.t * Word8.t -> Word8.t;
...
val rshift = _import "WordU8_rshift" private inline : Word8.t * Word32.t -> Word8.t;
val subCheckP = _import "WordU8_subCheckP" private inline : Word8.t * Word8.t -> Bool.t;
end
end
end
