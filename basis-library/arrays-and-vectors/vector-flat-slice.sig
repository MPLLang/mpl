signature VECTOR_FLAT_SLICE =
sig
  type 'a slice

  val length: 'a slice -> int
  val sub: 'a slice * int -> 'a
  val full: 'a VectorFlat.t -> 'a slice
  val slice: 'a VectorFlat.t * int * int option -> 'a slice
  val subslice: 'a slice * int * int option -> 'a slice
  val base: 'a slice -> 'a VectorFlat.t * int * int
  val vector: 'a slice -> 'a VectorFlat.t
  val concat: 'a slice list -> 'a VectorFlat.t
  val isEmpty: 'a slice -> bool
  val getItem: 'a slice -> ('a * 'a slice) option
  val appi: (int * 'a -> unit) -> 'a slice -> unit
  val app: ('a -> unit) -> 'a slice -> unit
  val mapi: (int * 'a -> 'b) -> 'a slice -> 'b VectorFlat.t
  val map: ('a -> 'b) -> 'a slice -> 'b VectorFlat.t
...
signature VECTOR_FLAT_SLICE_EXTRA =
sig
  include VECTOR_FLAT_SLICE
  ...
  val unsafeSlice: 'a VectorFlat.t * int * int option -> 'a slice
  val unsafeSubslice: 'a slice * int * int option -> 'a slice

  (* Used to implement Substring/String functions *)
  val concatWith: 'a VectorFlat.t -> 'a slice list -> 'a VectorFlat.t
  val triml: int -> 'a slice -> 'a slice
  val trimr: int -> 'a slice -> 'a slice
  val isPrefix: ('a * 'a -> bool) -> 'a VectorFlat.t -> 'a slice -> bool
  val isSubvector: ('a * 'a -> bool) -> 'a VectorFlat.t -> 'a slice -> bool
  val isSuffix: ('a * 'a -> bool) -> 'a VectorFlat.t -> 'a slice -> bool
  ...
  val translate: ('a -> 'b VectorFlat.t) -> 'a slice -> 'b VectorFlat.t
