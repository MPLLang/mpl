...
sig
  ...
  (* mark suspended job as available -- it will then be returned by some
   future 'get' *)
  val resumeWork : Priority.t * proc * susp * (token * work) -> unit
  ...
  val removeWorkPrio : Priority.t * proc * token -> bool
