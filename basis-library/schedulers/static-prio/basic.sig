...
sig
  ...
  val init : unit -> unit
  val initPriorities : unit -> unit
  val finalizePriorities : unit -> unit
  val currentPrio : unit -> Priority.t
  ...
  val removePrio : Priority.t -> token -> bool
  ...
  val delayedAddPrio : Priority.t * work -> unit
