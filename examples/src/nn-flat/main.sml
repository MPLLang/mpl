...
val (input, tm) = Util.getTime (fn _ => SeqFlat.tabulate genPoint n)
...
val _ = ForkJoin.parfor 10000 (0, SeqFlat.length input) (fn i =>
  line (pos (SeqFlat.nth input i)) (pos (SeqFlat.nth input (Seq.nth nbrs i))))

(* mark input points as a pixel *)
val _ =
  ForkJoin.parfor 10000 (0, SeqFlat.length input) (fn i =>
    let
      val (x, y) = pos (SeqFlat.nth input i)
