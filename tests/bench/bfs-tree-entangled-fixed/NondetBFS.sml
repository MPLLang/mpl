...
struct
  ...
  fun bfs (g : G.graph) (s : vertex) =
    let
      ...
      val isVisited = strip (Seq.tabulate (fn _ => 0w0: Word8.word) n)
      ...
      *)
      ...
      fun topDown frontier =
        let
          ...
          fun claim u =
            sub (isVisited, u) = 0w0
            andalso
            0w0 = Concurrency.casArray (isVisited, u) (0w0, 0w1)
      ...
      val _ = upd (isVisited, vtoi s, 0w1)
