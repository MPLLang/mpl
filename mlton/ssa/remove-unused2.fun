...
*)
                              ...
                              case Type.dest (tyVar base) of
                                 Type.Object {con, ...} =>
                                    (case con of
                                      ...
                                      | Sequence _ => Error.bug "RemoveUnused2.visitExp: Select:non-Con|Tuple"
                                      | Tuple => ())
          ...
          | Sequence {args} => Vector.foreach (args, visitVars)
          | Var x => visitVar x
      ...
      fun visitStatement s =
         case s of
          ...
          | Profile _ => ()
          | Update {base, offset, value, writeBarrier = _} =>
               let
                  datatype z = datatype Base.t
                  datatype z = datatype ObjectCon.t
               in
                        ...
                        (case Type.dest (tyVar base) of
                            Type.Object {con, ...} =>
                               (case con of
                                 ...
                                 | Sequence _ => Error.bug "RemoveUnused2.visitStatement: Update:non-Con|Tuple"
                                 | Tuple =>
                                      (visitVar base
                                       ; visitVar value))
                           ...
                           case Type.dest (tyVar base) of
                              Object {con, ...} =>
                                 (case con of
                                   ...
                                   | Sequence _ => Error.bug "RemoveUnused2.simplifyExp: Update:non-Con|Tuple"
                                   | Tuple => e)
                           ...
                           case Type.dest (tyVar base) of
                              Object {con, ...} =>
                                 (case con of
                                   ...
                                   | Sequence _ => Error.bug "RemoveUnused2.simplifyStatement: Update:non-Con|Tuple"
                                   | Tuple => SOME s)
