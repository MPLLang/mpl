...
fun transform (Program.T {datatypes, globals, functions, main}) =
   let
      ...
      val _ = initTyconInfo (tyconVoid, Vector.new0())
       ...
       * eliminate the datatype (unless it is an FFI type).
       *)
         ...
         case e of
            ConApp {con, args} =>
               (case conRep con of
                 ...
                 | ConRep.FFI =>
                      Error.bug "SimplifyTypes.simplfyExp: ConApp, ConRep.FFI")
