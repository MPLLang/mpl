...
sig
    ...
    val mods : modstate -> modifier list

    (* Return KeyC events (with chars) instead of Key events.
       Default: false *)
    val usechar : bool -> unit
    ...
    (* Polling *)
    val mousepos : display -> window -> int * int
    val buttons : display -> window -> button list
    val button : display -> window -> bool
    val modstate : display -> window -> modifier list
