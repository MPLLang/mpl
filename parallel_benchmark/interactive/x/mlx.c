...
char *ml_creategc(Display * d, Window w) {

  XGCValues dummy;
  return (char *)XCreateGC(d, w, 0, &dummy);
...
int MLX_ShiftMask = ShiftMask;
int MLX_LockMask = LockMask;
int MLX_ControlMask = ControlMask;
int MLX_Mod1Mask = Mod1Mask;
int MLX_Mod2Mask = Mod2Mask;
int MLX_Mod3Mask = Mod3Mask;
int MLX_Mod4Mask = Mod4Mask;
int MLX_Mod5Mask = Mod5Mask;
int MLX_Button1Mask = Button1Mask;
int MLX_Button2Mask = Button2Mask;
int MLX_Button3Mask = Button3Mask;
int MLX_Button4Mask = Button4Mask;
int MLX_Button5Mask = Button5Mask;
