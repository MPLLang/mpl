#ifndef __FIB1_ML_H__
#define __FIB1_ML_H__
...
#if !defined(PART_OF_FIB1) && \
    !defined(STATIC_LINK_FIB1) && \
    !defined(DYNAMIC_LINK_FIB1)
#define DYNAMIC_LINK_FIB1
#endif

#if defined(PART_OF_FIB1)
#define MLLIB_PRIVATE(x) PRIVATE x
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(STATIC_LINK_FIB1)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(DYNAMIC_LINK_FIB1)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) EXTERNAL x
#else
#error Must specify linkage for fib1
#define MLLIB_PRIVATE(x)
...
MLLIB_PUBLIC(void fib1_open(int argc, const char** argv);)
MLLIB_PUBLIC(void fib1_close();)
MLLIB_PUBLIC(Int32 fib (Int32 x0);)
